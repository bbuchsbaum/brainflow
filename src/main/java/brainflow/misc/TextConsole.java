...
class TextConsole extends JTextPane {
	...
	/**
	 * set the cursorPos position on screen
	 */
	...
	/**
	 * set the cursorPos position on the first
	...
	/**
	 * AFNIAttributeKey processing function. Certain key events
	 ...
	 * of the foreground text under the cursorPos
	 */
	...
	/**
	 * Move cursorPos to prescribed position and write
	 * text to screen
	 */
	...
	/**
	 * Move cursorPos to prescribed position, set foreground color
	...
	/**
	 * Move the cursorPos to a prescribed position on the screen and
	 * add a form field.
	 * @see addFormField()
	 */
	...
	/**
	 * Move the cursorPos to a prescribed position on the screen,
