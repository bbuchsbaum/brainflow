...
public class Space {
    ...
    public static boolean containsPoint(IImageSpace3D space, SpatialLoc3D pt) {
        SpatialLoc3D cpt = pt.convertTo(space);
    ...
    public static boolean containsPoint(IImageSpace3D space, VoxelLoc3D pt) {
