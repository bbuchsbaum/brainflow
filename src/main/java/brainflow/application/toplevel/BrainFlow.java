...
import brainflow.application.dnd.BrainCanvasTransferHandler;
import brainflow.application.actions.*;
import brainflow.application.presentation.*;
...
public class BrainFlow {
    ...
    public static BrainFlow get() {
        return (BrainFlow) SingletonRegistry.REGISTRY.getInstance("brainflow.application.toplevel.BrainFlow");
    }
