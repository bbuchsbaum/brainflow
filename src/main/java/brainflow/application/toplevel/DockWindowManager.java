...
import brainflow.application.actions.ActivateDockableFrameCommand;
...
class DockWindowManager implements DockableFrameListener {
    ...
    public static DockWindowManager getInstance() {
        return (DockWindowManager) SingletonRegistry.REGISTRY.getInstance("brainflow.application.toplevel.DockWindowManager");
    }
